      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- <a href="{{ route('posts.cetak') }}" target="_blank"><button type="button" class ="btn btn-warning"><i class="bi bi-printer"></i>Print</button> </a>
                <br/> -->
            ...
            <form action="{{ route('posts.cari') }}" method="GET"
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('posts.create') }}" class="btn btn-md btn-success mb-3"><i class="bi bi-cloud-plus"></i></a>
                            ...
                            <tbody>
                              ...
                              @forelse ($posts as $post)
                                <tr>
                                    ...
                                    <td class="text-cente r">{{ $post->kelas }}</td>
