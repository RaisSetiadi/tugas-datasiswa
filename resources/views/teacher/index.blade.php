...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('image/pi.jpg')}}" alt="Smk PI" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="image/pi.jpg" alt="Smk Pi" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="/walikelas/home" class="nav-link active">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center my-4">Data Siswa SMK Prakarya International</h3>
                    <!-- <h5 class="text-center"><a href="https://santrikoding.com">www.santrikoding.com</a></h5>          -->
                    <hr>
                </div>
                <div class="container">
                <form method="GET" action ="{{route('teacher.cari')}}" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
